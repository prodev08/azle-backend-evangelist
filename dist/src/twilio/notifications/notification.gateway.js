...
NotificationGateway = __decorate([
    ...
    (0, websockets_1.WebSocketGateway)({
        namespace: '/sms',
        cors: {
            origin: [process.env.WEB_SOCKET_ORIGIN, "https://*.azle.io", "http://busin.azle.io", "http://localhost:3000", "https://azle-widget.netlify.app", "https://test.azle.io", "https://business.azle.io"],
            methods: ['GET', 'POST'],
            credentials: true
        },
        allowEIO3: true
